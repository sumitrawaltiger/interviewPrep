...
const SKILL_DEFS = [
  ...
  {
    icon: '📜', color: '#EAB308', dark: '#CA8A04', bg: '#FEFCE8', border: '#FDE047', block: 'b1',
  ...
  {
    icon: '🔷', color: '#2563EB', dark: '#1D4ED8', bg: '#EFF6FF', border: '#BFDBFE', block: 'b1',
  ...
  {
    icon: '⚛', color: '#0EA5E9', dark: '#0369A1', bg: '#F0F9FF', border: '#BAE6FD', block: 'b1',
  ...
  {
    icon: '▲', color: '#171717', dark: '#000000', bg: '#F5F5F5', border: '#D4D4D4', block: 'b1',
  ...
  {
    icon: '📱', color: '#7C3AED', dark: '#6D28D9', bg: '#F5F3FF', border: '#DDD6FE', block: 'b1',
  ...
  {
    icon: '🟢', color: '#16A34A', dark: '#15803D', bg: '#F0FDF4', border: '#BBF7D0', block: 'b1',
  ...
  {
    icon: '🐍', color: '#15803D', dark: '#166534', bg: '#F0FDF4', border: '#86EFAC', block: 'b2',
    name: 'Python', weeks: 4,
  ...
  {
    icon: '🎸', color: '#092E20', dark: '#051B14', bg: '#ECFDF5', border: '#6EE7B7', block: 'b2',
    name: 'Django', weeks: 4,
  ...
  {
    icon: '⚡', color: '#009688', dark: '#00796B', bg: '#E0F2F1', border: '#80CBC4', block: 'b2',
  ...
  {
    icon: '🤖', color: '#8B5CF6', dark: '#6D28D9', bg: '#F5F3FF', border: '#DDD6FE', block: 'b2',
  ...
  {
    icon: '☕', color: '#EA580C', dark: '#C2410C', bg: '#FFF7ED', border: '#FED7AA', block: 'b3',
    name: 'J2SE', weeks: 4,
  ...
  {
    icon: '🏢', color: '#0891B2', dark: '#0E7490', bg: '#ECFEFF', border: '#A5F3FC', block: 'b3',
    name: 'J2EE', weeks: 4,
  ...
  {
    icon: '🗄', color: '#7C3AED', dark: '#6D28D9', bg: '#F5F3FF', border: '#DDD6FE', block: 'b3',
    name: 'JPA', weeks: 3,
  ...
  {
    icon: '🌱', color: '#6DB33F', dark: '#4E9A2E', bg: '#F0FDF4', border: '#86EFAC', block: 'b3',
  ...
  {
    icon: '🏛', color: '#E11D48', dark: '#BE123C', bg: '#FFF1F2', border: '#FECDD3', block: 'b3',
  ...
  {
    icon: '🔧', color: '#6366F1', dark: '#4338CA', bg: '#EEF2FF', border: '#C7D2FE', block: 'b4',
  ...
  {
    icon: '☸', color: '#326CE5', dark: '#1D4ED8', bg: '#EFF6FF', border: '#BFDBFE', block: 'b4',
...
const BLOCK_META = {
  ...
  b1: { icon: '🎓', col: '#E11D48', title: 'JavaScript Ecosystem', detail: 'Javascript → Typescript → React → Next JS → React Native → Node JS' },
