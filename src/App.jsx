...
const PHASES = [
...

  {
    ...
    ms: 'AWS ×3 Certs DONE · D873',
    about:
      '191 study days · ~7 months. Three AWS certifications back to back with extra depth time (27 days from former capstone). Months 1-2: SAA-C03 (Solutions Architect Associate). Months 3-4: DVA-C02 (Developer Associate) — Lambda, DynamoDB, API Gateway, Cognito, Step Functions (your exact FPO stack!). Months 5-7+: DOP-C02 (DevOps Engineer Professional). All Stephane Maarek + Tutorials Dojo practice exams.',
    courses: [
    ...
    wplan: [
      ...
      },
      {
        ...
        t: 'Tutorials Dojo DOP-C02 mocks (hardest AWS cert). Sit DOP-C02. All 3 AWS certifications achieved. Credly badges + LinkedIn update. D873 = AWS DONE 🎉',
      },
      {
        w: 14,
        f: 'AWS Deep Dive + FPO Stack Revision',
        t: 'Extra 27 days: Lambda/Step Functions/DynamoDB/CDK deep revision, hands-on FPO Cloud labs, whiteboard architecture reviews, weak-area drills across all 3 cert domains.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    ms: 'Terraform Associate Done · D924',
    about:
  ...
  },
  {
    ...
    ms: 'Oracle Java SE 17 Cert Done · D950',
    about:
  ...
  },
  {
    ...
    ms: 'All 9 Certs + 1000 DAYS COMPLETE · D1000 · Mar 15, 2029',
    about:
      '26 study days. VMware/Broadcom Spring Professional 2024 (EDU-1202). Spring Core, Boot, MVC, Data JPA, Security, Testing. Final phase — D1000 = Mar 15, 2029 = 1000 DAYS OF CODE COMPLETE. Use 96 relaxation days before Jun 19, 2029 if you miss a 5:30 AM slot.',
    courses: [
    ...
    wplan: [
      ...
      {
        w: 4,
        f: 'Spring Cert + 1000 Days Done',
        t: 'Sit Spring Professional exam. All 9 badges on Credly: AWS×3, CKA, Terraform, Java, Python, Spring. D1000 = Mar 15, 2029 = 1000 DAYS OF CODE COMPLETE 🏆',
      },
    ],
  },
];
...
const MILESTONES = [
  ...
  { day: 873, icon: '☁', label: 'AWS ×3 Certs Done', date: 'Nov 8, 2028', color: '#D97706' },
  { day: 898, icon: '☸', label: 'CKA Done', date: 'Dec 3, 2028', color: '#4338CA' },
  { day: 924, icon: '🏗', label: 'Terraform Done', date: 'Dec 29, 2028', color: '#B45309' },
  { day: 950, icon: '☕', label: 'Java SE 17 Done', date: 'Jan 24, 2029', color: '#EA580C' },
  { day: 974, icon: '🐍', label: 'Python PCEP+PCAP Done', date: 'Feb 17, 2029', color: '#16A34A' },
  { day: 1000, icon: '🏆', label: 'Spring Cert — 1000 DAYS DONE', date: 'Mar 15, 2029', color: '#E11D48' },
];
...
export default function App() {
  ...
  const sections = [
    ...
    },
    {
      ...
      sub: 'D488–D1000 · Oct 20, 2027 – Jun 19, 2029 · 513 study days · 96 relaxation · DSA → System Design → AWS×3 (extended) → CKA+TF+Java+Python+Spring Certs',
