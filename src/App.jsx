...
// 16 Month Skill Plan · Oct 1, 2026 → Jan 31, 2028
...
const BLOCKS = [
  {
    ...
    icon: '🌐',
    col: '#0EA5E9',
    title: 'Months 1–4 · Frontend Web',
    sub: 'D1–D123 · Oct 2026 – Jan 2027',
    detail: 'Javascript → Typescript → React JS → Next JS',
  ...
  },
  {
    ...
    icon: '📱',
    col: '#16A34A',
    title: 'Months 5–8 · Mobile & Backend',
    sub: 'D124–D243 · Feb – May 2027',
    detail: 'React Native → Node JS → Python → Fast API',
    time: '5:30 AM – 8:30 AM IST · 3h daily',
  },
  {
    id: 'b3',
    icon: '🐍',
    col: '#8B5CF6',
    title: 'Months 9–12 · Python & Java Core',
    sub: 'D244–D365 · Jun – Sep 2027',
    detail: 'Django → Agentic AI → J2SE → J2EE',
    time: '5:30 AM – 8:30 AM IST · 3h daily',
  },
  {
    id: 'b4',
    icon: '☕',
    col: '#E11D48',
    title: 'Months 13–16 · Java Enterprise & DevOps',
    sub: 'D366–D488 · Oct 2027 – Jan 2028',
    detail: 'JPA → Spring Boot → Microservices → Devops',
    time: '5:30 AM – 8:30 AM IST · 3h daily',
  },
];
...
const PHASES = [
  {
    ...
    border: '#FDE047',
    name: 'Javascript',
    label: 'Month 1 · 31 days',
    days: 31,
    ds: 1,
    de: 31,
    period: 'Oct 1 – Oct 31, 2026',
    ms: 'Javascript Complete · D31',
    about: 'Month 1. JavaScript ES6+ fundamentals: variables, functions, closures, prototypes, arrays/objects, map/filter/reduce, async/await, Promises, modules. Build 8 mini projects. Foundation for TypeScript and React.',
    courses: [
  ...
  },
  {
    ...
    border: '#BFDBFE',
    name: 'Typescript',
    label: 'Month 2 · 30 days',
    days: 30,
    ds: 32,
    de: 61,
    period: 'Nov 1 – Nov 30, 2026',
    ms: 'Typescript Complete · D61',
    about: 'Month 2. TypeScript strict mode: types, interfaces, generics, utility types, enums, tuples, type guards, narrowing. Configure tsconfig. Refactor Month 1 JS projects to TypeScript.',
    courses: [
  ...
  },
  {
    ...
    border: '#BAE6FD',
    name: 'React JS',
    label: 'Month 3 · 31 days',
    days: 31,
    ds: 62,
    de: 92,
    period: 'Dec 1 – Dec 31, 2026',
    ms: 'React JS Complete · D92',
    about: 'Month 3. React 19: components, JSX, props, state, hooks (useState, useEffect, useContext, useReducer, useMemo, useCallback), React Router, Redux Toolkit, RTK Query, testing with React Testing Library.',
    courses: [
  ...
  },
  {
    ...
    border: '#D4D4D4',
    name: 'Next JS',
    label: 'Month 4 · 31 days',
    days: 31,
    ds: 93,
    de: 123,
    period: 'Jan 1 – Jan 31, 2027',
    ms: 'Next JS Complete · D123',
    about: 'Month 4. Next.js 15 App Router: Server Components, Server Actions, layouts, loading/error states, NextAuth, Prisma ORM, API routes, middleware, image optimization, deploy to Vercel. FPO web portal foundation.',
    courses: [
  ...
  },
  {
    ...
    border: '#DDD6FE',
    name: 'React Native',
    label: 'Month 5 · 28 days',
    days: 28,
    ds: 124,
    de: 151,
    period: 'Feb 1 – Feb 28, 2027',
    ms: 'React Native Complete · D151',
    about: 'Month 5. React Native + Expo: navigation, device APIs, push notifications, offline storage, EAS Build, platform-specific code. Build FPO mobile flight status app for iOS and Android.',
    courses: [
  ...
  },
  {
    ...
    border: '#BBF7D0',
    name: 'Node JS',
    label: 'Month 6 · 31 days',
    days: 31,
    ds: 152,
    de: 182,
    period: 'Mar 1 – Mar 31, 2027',
    ms: 'Node JS Complete · D182',
    about: 'Month 6. Node.js: event loop, streams, fs/path, Express.js, REST APIs, middleware, JWT auth, WebSockets, npm ecosystem, error handling, logging. Build production Node API for FPO.',
    courses: [
  ...
  },
  {
    ...
    border: '#86EFAC',
    name: 'Python',
    label: 'Month 7 · 30 days',
    days: 30,
    ds: 183,
    de: 212,
    period: 'Apr 1 – Apr 30, 2027',
    ms: 'Python Complete · D212',
    about: 'Month 7. Python 3: fundamentals, OOP, decorators, generators, asyncio, type hints, virtual environments, pip, boto3 AWS automation, pandas basics. Foundation for FastAPI, Django, and Agentic AI.',
    courses: [
  ...
  },
  {
    ...
    border: '#80CBC4',
    name: 'Fast API',
    label: 'Month 8 · 31 days',
    days: 31,
    ds: 213,
    de: 243,
    period: 'May 1 – May 31, 2027',
    ms: 'Fast API Complete · D243',
    about: 'Month 8. FastAPI: async routes, Pydantic v2 models, dependency injection, OAuth2, JWT, SQLAlchemy, Alembic migrations, OpenAPI/Swagger auto-docs, deploy with Uvicorn + Docker on AWS.',
    courses: [
  ...
  },
  {
    ...
    border: '#6EE7B7',
    name: 'Django',
    label: 'Month 9 · 30 days',
    days: 30,
    ds: 244,
    de: 273,
    period: 'Jun 1 – Jun 30, 2027',
    ms: 'Django Complete · D273',
    about: 'Month 9. Django 5 + Django REST Framework: models, migrations, admin, class-based views, DRF serializers, viewsets, permissions, authentication, filtering, pagination. Build FPO admin backend.',
    courses: [
    ...
    wplan: [
      ...
      { w: 4, f: 'Week 4: FPO Admin', t: 'booking admin API, deploy on AWS Elastic Beanstalk' },
    ],
  },
  {
    id: 's10',
    ...
    border: '#DDD6FE',
    name: 'Agentic AI',
    label: 'Month 10 · 31 days',
    days: 31,
    ds: 274,
    de: 304,
    period: 'Jul 1 – Jul 31, 2027',
    ms: 'Agentic AI Complete · D304',
    about: 'Month 10. Agentic AI: LangChain, LangGraph, RAG pipelines, vector DBs, AWS Bedrock, multi-agent systems, MCP protocol. Ed Donner projects. Capstone: FPO AI assistant on Lambda.',
    courses: [
  ...
  },
  {
    ...
    border: '#FED7AA',
    name: 'J2SE',
    label: 'Month 11 · 31 days',
    days: 31,
    ds: 305,
    de: 335,
    period: 'Aug 1 – Aug 31, 2027',
    ms: 'J2SE Complete · D335',
    about: 'Month 11. Java SE: syntax, OOP, collections framework, streams, lambdas, Optional, records, generics, exception handling, file I/O, multithreading basics. Java 17+ features.',
    courses: [
  ...
  },
  {
    ...
    border: '#A5F3FC',
    name: 'J2EE',
    label: 'Month 12 · 30 days',
    days: 30,
    ds: 336,
    de: 365,
    period: 'Sep 1 – Sep 30, 2027',
    ms: 'J2EE Complete · D365',
    about: 'Month 12. Java EE / Jakarta EE: Servlets, JSP, JNDI, JDBC, connection pooling, transactions, Java EE architecture patterns, deployment descriptors, application servers overview.',
    courses: [
  ...
  },
  {
    ...
    border: '#DDD6FE',
    name: 'JPA',
    label: 'Month 13 · 31 days',
    days: 31,
    ds: 366,
    de: 396,
    period: 'Oct 1 – Oct 31, 2027',
    ms: 'JPA Complete · D396',
    about: 'Month 13. JPA/Hibernate: @Entity, relationships (OneToMany, ManyToMany), JPQL, Criteria API, Spring Data JPA, @Transactional, lazy/eager loading, N+1 problem, caching.',
    courses: [
  ...
  },
  {
    ...
    border: '#86EFAC',
    name: 'Spring Boot',
    label: 'Month 14 · 30 days',
    days: 30,
    ds: 397,
    de: 426,
    period: 'Nov 1 – Nov 30, 2027',
    ms: 'Spring Boot Complete · D426',
    about: 'Month 14. Spring Boot 3: auto-configuration, REST APIs, Spring Security + OAuth2 (FPO Cognito!), validation, OpenAPI, Actuator, testing with JUnit 5 + Mockito + Testcontainers.',
    courses: [
  ...
  },
  {
    ...
    border: '#FECDD3',
    name: 'Microservices',
    label: 'Month 15 · 31 days',
    days: 31,
    ds: 427,
    de: 457,
    period: 'Dec 1 – Dec 31, 2027',
    ms: 'Microservices Complete · D457',
    about: 'Month 15. Microservices: Spring Cloud, service discovery, API Gateway, Kafka, Resilience4j, CQRS, saga patterns, distributed tracing, DDD. Decompose FPO into microservices on AWS.',
    courses: [
  ...
  },
  {
    ...
    border: '#C7D2FE',
    name: 'Devops',
    label: 'Month 16 · 31 days',
    days: 31,
    ds: 458,
    de: 488,
    period: 'Jan 1 – Jan 31, 2028',
    ms: '16 MONTHS COMPLETE · D488 · Jan 31, 2028',
    about: 'Month 16. DevOps capstone: Docker, Kubernetes/EKS, CI/CD (GitHub Actions), Terraform, Prometheus/Grafana, SonarQube. End-to-end pipeline for FPO Cloud. PLAN COMPLETE Jan 31, 2028.',
    courses: [
...
const MILESTONES = [
  { day: 31, icon: '📜', label: 'Javascript Done', date: 'Oct 31, 2026', color: '#EAB308' },
  { day: 61, icon: '🔷', label: 'Typescript Done', date: 'Nov 30, 2026', color: '#2563EB' },
  { day: 92, icon: '⚛', label: 'React JS Done', date: 'Dec 31, 2026', color: '#0EA5E9' },
  { day: 123, icon: '▲', label: 'Next JS Done', date: 'Jan 31, 2027', color: '#171717' },
  { day: 151, icon: '📱', label: 'React Native Done', date: 'Feb 28, 2027', color: '#7C3AED' },
  { day: 182, icon: '🟢', label: 'Node JS Done', date: 'Mar 31, 2027', color: '#16A34A' },
  { day: 212, icon: '🐍', label: 'Python Done', date: 'Apr 30, 2027', color: '#16A34A' },
  { day: 243, icon: '⚡', label: 'Fast API Done', date: 'May 31, 2027', color: '#009688' },
  { day: 273, icon: '🎸', label: 'Django Done', date: 'Jun 30, 2027', color: '#092E20' },
  { day: 304, icon: '🤖', label: 'Agentic AI Done', date: 'Jul 31, 2027', color: '#8B5CF6' },
  { day: 335, icon: '☕', label: 'J2SE Done', date: 'Aug 31, 2027', color: '#EA580C' },
  { day: 365, icon: '🏢', label: 'J2EE Done', date: 'Sep 30, 2027', color: '#0891B2' },
  { day: 396, icon: '🗄', label: 'JPA Done', date: 'Oct 31, 2027', color: '#7C3AED' },
  { day: 426, icon: '🌱', label: 'Spring Boot Done', date: 'Nov 30, 2027', color: '#6DB33F' },
  { day: 457, icon: '🏛', label: 'Microservices Done', date: 'Dec 31, 2027', color: '#E11D48' },
  { day: 488, icon: '🔧', label: 'Devops — 16 MONTHS DONE', date: 'Jan 31, 2028', color: '#6366F1' },
];
function daysIn() {
  ...
  const sections = [
    {
      col: '#0EA5E9',
      title: '🌐 MONTHS 1–4 · FRONTEND WEB',
      sub: 'Oct 2026 – Jan 2027 · Javascript → Typescript → React JS → Next JS',
      ids: ['s1', 's2', 's3', 's4'],
    },
    {
      col: '#16A34A',
      title: '📱 MONTHS 5–8 · MOBILE & BACKEND',
      sub: 'Feb – May 2027 · React Native → Node JS → Python → Fast API',
      ids: ['s5', 's6', 's7', 's8'],
    },
    {
      col: '#8B5CF6',
      title: '🐍 MONTHS 9–12 · PYTHON & JAVA CORE',
      sub: 'Jun – Sep 2027 · Django → Agentic AI → J2SE → J2EE',
      ids: ['s9', 's10', 's11', 's12'],
    },
    {
      col: '#E11D48',
      title: '☕ MONTHS 13–16 · JAVA ENTERPRISE & DEVOPS',
      sub: 'Oct 2027 – Jan 2028 · JPA → Spring Boot → Microservices → Devops',
      ids: ['s13', 's14', 's15', 's16'],
    },
  ];
    ...
    >
        ...
        >
          ...
          >
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              >
                {
                  'Wed Oct 1, 2026 → Mon Jan 31, 2028 · 5:30 AM – 8:30 AM IST · 3h · 488 study days · 16 skills'
                }
              </div>
            </div>
          </div>
      ...
      >
        ...
        >
          ...
          >
            {'🏆 16 Month Skill Plan · Oct 1, 2026 → Jan 31, 2028 · 16 skills × 1 month'}
          </div>
          <div
            style={{
              fontSize: 9,
          ...
          >
            {
              'JS → TS → React → Next → RN → Node → Python → FastAPI → Django → Agentic AI → J2SE → J2EE → JPA → Spring Boot → Microservices → DevOps · 5:30–8:30 AM IST · 3h'
            }
          </div>
          <div
            style={{
