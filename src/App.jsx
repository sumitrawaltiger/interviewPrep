...
const BLOCKS = [
  ...
  },
  {
    ...
    detail: 'JavaScript — block 3 of 10',
    time: '5:30 AM – 8:30 AM · 3h daily',
  },
  {
    id: 'b4',
  ...
  },
  {
    ...
    detail: 'Data Structures — block 7 of 10',
    time: '5:30 AM – 8:30 AM · 3h daily',
  },
  {
    id: 'b8',
    ...
    detail: 'System Design — block 8 of 10',
    time: '5:30 AM – 8:30 AM · 3h daily',
  },
  {
    id: 'b9',
    icon: '🤖',
    col: '#8B5CF6',
    title: '100 Days of Agentic AI',
    sub: 'D801–D900 · Sep 2 – Dec 10, 2028 · 100 days',
    detail: 'Agentic AI — block 9 of 10',
    time: '5:30 AM – 8:30 AM · 3h daily',
  },
  {
    id: 'b10',
    icon: '🎯',
    col: '#E11D48',
    title: '100 Days of Interview Preparation',
    sub: 'D901–D1000 · Dec 11, 2028 – Mar 20, 2029 · 100 days',
    detail: 'Interview Preparation — block 10 of 10',
    time: '5:30 AM – 8:30 AM · 3h daily',
  },
];
...
const PHASES = [
  ...
  },
  {
    ...
    ms: 'Python Complete · D200',
    about: '100 study days. Python 3 mastery: fundamentals, OOP, decorators, generators, asyncio, type hints, boto3, FastAPI basics, Django REST Framework intro, data processing with pandas. Foundation for Agentic AI block later.',
    courses: [
  ...
  },
  {
    ...
    ms: 'Java Complete · D500',
    about: '100 study days. Java enterprise stack: J2SE, J2EE, JPA/Hibernate, Spring Boot 3, Spring Security + OAuth2 (FPO Cognito!), Spring Cloud microservices, Kafka, deploy to AWS ECS/EKS.',
    courses: [
    ...
    wplan: [
      ...
      { w: 3, f: 'Weeks 5-6: Spring Boot + Security', t: 'REST APIs, JWT, OAuth2 resource server, OpenAPI' },
      { w: 4, f: 'Weeks 7-8: Microservices', t: 'Spring Cloud, Kafka, Resilience4j, CQRS intro' },
      { w: 5, f: 'Weeks 9-10: Java Capstone', t: 'Full Spring Boot API deployed to AWS ECS' },
    ],
  },
  {
    id: 'p6',
  ...
  },
  {
    ...
    ms: 'Data Structures Complete · D700',
  ...
  },
  {
    ...
    ms: 'System Design Complete · D800',
    about: '100 study days. System design interview mastery. Frank Kane framework, Alex Xu designs, classic systems (URL Shortener, WhatsApp, Twitter, YouTube, Uber, Payment). FPO Cloud as real case study. 20 spoken-aloud designs.',
    courses: [
    ...
    wplan: [
      ...
      { w: 5, f: 'Weeks 9-10: Mock SD Interviews', t: '10 full cold mock interviews + ADRs + portfolio diagrams' },
    ],
  },
  {
    id: 'p9',
  ...
  },
  {
    ...
    about: '100 study days. Final interview sprint: Java 8 + Streams tricky Qs, React hooks Qs, Python Qs, AWS/K8s/DevOps scenario Qs, coding mocks, system design refresh, behavioural STAR stories. Portfolio polish. D1000 = DONE.',
    courses: [
      'GreatFrontEnd — React + JS interview Qs',
      'Ed Yordan — Java + Python interview Qs',
      'Pramp.com + interviewing.io',
      'Your GitHub portfolio — README overhaul',
    ],
    wplan: [
      { w: 1, f: 'Weeks 1-2: Java + Python Interview Qs', t: 'Java 8/Streams traps, Python OOP/decorators/GIL — 80 Qs' },
      { w: 2, f: 'Weeks 3-4: React + AWS + DevOps Qs', t: 'hooks, reconciliation, AWS architecture, K8s troubleshooting' },
      { w: 3, f: 'Weeks 5-6: Coding + SD Mocks', t: 'LeetCode timed sets, 10 system design mocks' },
      { w: 4, f: 'Weeks 7-8: Behavioural + Portfolio', t: 'STAR stories from FPO/SCB, resume v3, LinkedIn' },
      { w: 5, f: 'Weeks 9-10: Final Interview Sprint', t: '20 full mock interviews across all domains. D1000 COMPLETE 🏆' },
    ],
  },
];
...
const MILESTONES = [
  ...
  { day: 200, icon: '🐍', label: 'Python Done', date: 'Jan 10, 2027', color: '#16A34A' },
  { day: 300, icon: '📜', label: 'JavaScript Done', date: 'Apr 20, 2027', color: '#EAB308' },
  { day: 400, icon: '⚛', label: 'React Done', date: 'Jul 29, 2027', color: '#0EA5E9' },
  { day: 500, icon: '☕', label: 'Java Done', date: 'Nov 6, 2027', color: '#EA580C' },
  { day: 600, icon: '🔧', label: 'DevOps Done', date: 'Feb 14, 2028', color: '#6366F1' },
  { day: 700, icon: '🧩', label: 'Data Structures Done', date: 'May 24, 2028', color: '#4F46E5' },
  { day: 800, icon: '🏗', label: 'System Design Done', date: 'Sep 1, 2028', color: '#7C3AED' },
  { day: 900, icon: '🤖', label: 'Agentic AI Done', date: 'Dec 10, 2028', color: '#8B5CF6' },
  { day: 1000, icon: '🎯', label: 'Interview Preparation — 1000 DAYS DONE', date: 'Mar 20, 2029', color: '#E11D48' },
];
function daysIn() {
  ...
  const sections = [
    {
      ...
      sub: 'D1–D1000 · Jun 25, 2026 – Mar 20, 2029 · AWS → Python → JS → React → Java → DevOps → DSA → System Design → Agentic AI → Interview Prep',
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            {
              'AWS → Python → JS → React → Java → DevOps → DSA → System Design → Agentic AI → Interview Prep · 5:30–8:30 AM · 3h'
            }
          </div>
          <div
            style={{
